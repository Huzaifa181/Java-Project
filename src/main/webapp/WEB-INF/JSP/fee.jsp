    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="jumbotron jumbotron-fluid">
                <div class="container">
                    <h1 class="display-4">Submit Fee</h1>
            ...
            <div class="row">
                ...
                <div class="col-7 col-sm-12 col-md-7">
                    ...
                    <div class="container border rounded ">
                        <form:form method="post" action="/CinemaProject/fee" commandName="fee">
	<div class="table-responsive">
		<table class="table" style="width: 300px; margin:0px auto; border:none">
			...
			<label>
				...
				<td><form:input type="text" path="fee" placeholder="Enter Fee" style="height:35px;width:200px"/></td>
				</label>
			</tr>
