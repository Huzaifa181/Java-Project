...
<div class="header">
    <div class="head">
        ...
        <div class="navMenu">
            ...
            <a href="/CinemaProject/registration" onClick="j">Signout</a>
            </div>
            </div>
            </div>
	<div class="box">
<form:form method="post" action="/CinemaProject/addHollywoodMovies.html"  commandName="movies">
<h1 style="text-align:center;margin-bottom:40px">Add Bollywood Movie</h1>
			<label>	
...
<label>	
				...
				<div><form:input type="time" path="endingDate" placeholder="Enter the Description" style="height:27px;width:200px" /></div>
</label>
